/**
 * Reacticx fork, vendored from:
 * https://github.com/rit3zh/reacticx/tree/main/src/components/micro-interactions/spin-button
 *
...
// Interfaces carry no implicit index signature, so T must be constrained to
// object (not Record<string, unknown>) for config interfaces to infer back
// as themselves; the record casts live inside, at the leaves.
